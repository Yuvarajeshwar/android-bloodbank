        ...
        singleuser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (name.toLowerCase().contains("admin")) {
                    // User is an admin, show admin-specific features (e.g., Create User button)
                    showAdminFeatures();
                }
...
private void showAdminFeatures() {
    ...
    // Set the click listener for the "Create User" button
    createUserButton.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            // Navigate to ProfileActivity to create a new user
            Intent intent = new Intent(Dashboard.this, ProfileActivity.class);
            intent.putExtra("isCreatingNewUser", true); // Optional: If you want to pass an extra to indicate it's for a new user
